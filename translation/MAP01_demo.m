...
The gate mechanism is missing a gear. 
...
(A slight pellicle of dust covers the pages of this journal.)
...
can grown my own food here. Who would have ever imagined that one could shrink her entire library and
...
we know it.  It is thus our duty to protect it at any cost, for without it, we would crumble into pieces.
...
responsible with a part of the integrity of their no longer nomadic tribe.    They would all use their
gifts in various ways,  with the major purpose of erecting Valc from cold stone and turning it into a
grand city. No longer would they search their place, for the crystal caverns gave them everything.
...
Now that these hanging cyan crystals have been destroyed, the nature's power will begin to dwindle...
...
fools that failed to slay these pesky green runts. Blowing the way to the northern wing did nothing but
delay us. They SHOULD have imagined you can't trap them in a place sprawling with ventilation shafts. 
...
her way towards our...  goal.  Do NOT let her touch the portal here.  Reinforce the main gates, have
...
couldn't get past the root gate. Still, neither can we... we've tried everything, but the roots simply
regenerate faster than we can damage them! We know they're using the tablets to recite a spell that
grants them passage, but that bitch guarding the library must have \1c[Gold]hidden the tablet\1c- before we got
here. Whatever lies on the floor above, it must be valuable to them! Perhaps it's the very key to the
Portal controls! Nobody else has found it, right? We NEED to find that darned tablet. And I need aid.
The greenskin couldn't have had much time to hide the tablet after hearing us warp and commence the
attack, so I assume it must be on this floor somewhere. I've had the cultists search the place, but to
...
suddenly and sliced my leg clean. I'm done for... Arva went out to search for the key to turn the damned
...
Tip: Press \1c[White]F1\1c- at any time to view the quick reference screen.
All messages can be reviewed in the console \1c[White](default: Tilde)\1c- 
Tip: You won't get far without a map \1c[White](default: TAB)\1c-
It has an overlay and normal mode that can be configured from: Options - Automap Options
While in normal mode, you can zoom in/out \1c[White](default: MWheel)\1c- and mark your current position with \1c[White](default: M)\1c- 
Tip: Quest Items are not required to be manually selected.
They are used automatically with \1c[White](default: E)\1c- 
Tip: Use consumables with \1c[White](default: F)\1c-
Consumables and Quest Items are stored in your inventory. Scroll through it with \1c[White](default: Z/X)\1c-
You can inspect the currently selected item for a brief description with \1c[White](default: ENTER)\1c-
You can also set hotkeys for these items, or see the default ones in the help screen \1c[White](default: F1)\1c- 
...
Tip: Every weapon has an alternative attack mode \1c[White](default: RMB)\1c-
You can perform quick kick attacks with \1c[White](default: Q)\1c-
Kicks are stronger when combined with jumping and crouching. 
Tip: You can only carry one Axe without a Bag of Holding. 
Tip: \1c[White]Keys\1c- show at the bottom right of the HUD.
Locked doors have a corresponding icon that can be seen on the map \1c[White](default: TAB)\1c- 
Tip: Read scrolls, signs, tablets and books with \1c[White](default: E)\1c- 
Tip: You can avoid alerting groups of enemies by attacking with your fists \1c[White](default: 1)\1c- 
Tip: Scroll through your inventory with \1c[White](default: Z/X)\1c-
Inspect your currently selected item with \1c[White](default: ENTER)\1c- 
Tip: Inspect your currently selected item with \1c[White](default: ENTER)\1c- 
Tip: You can toggle sprinting with \1c[White](default: Caps Lock)\1c- 
Tip: Use the door with the Fist Symbol to end the level. 
Tip: \1c[White]Consumables\1c- can be used anytime with \1c[White](default: F)\1c-
